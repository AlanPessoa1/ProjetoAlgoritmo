...
public class TelaEdicaoLabirintoController {
    ...
    private static TelaEdicaoLabirintoController instance;

    private int[][] matrizLabirintoEditado;
    ...
    public static TelaEdicaoLabirintoController getInstancia() {
        if (instance == null) {
            instance = new TelaEdicaoLabirintoController();
        }
        return instance;
    }
    ...
    public void initialize() throws IOException {
        ...
        setMatrizLabirintoEditado(labirinto.obterLabirinto());
    }
                ...
                imageView.setOnMouseClicked(e -> {
                    ...
                    switch (currentValue) {
                        case 0:
                            ...
                            matrizLabirintoEditado[finalY][finalX] = 1;
                            break;
                        case 1:
                            imageView.setImage(new Image("caminho5.jpg"));
                            matrizLabirinto[finalY][finalX] = 0;
                            matrizLabirintoEditado[finalY][finalX] = 0;
                            break;
                        case 2, 3:
    ...
    public int[][] getMatrizLabirintoEditado() {
        return matrizLabirintoEditado;
    }

    public void setMatrizLabirintoEditado(int[][] matrizLabirintoEditado) {
        this.matrizLabirintoEditado = matrizLabirintoEditado;
    }
